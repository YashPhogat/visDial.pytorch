...
for sigma in sigmas:
    for alpha in alphas:
        ...
        os.system("python ../eval/eval_D.py --cuda --path_to_home '"+ path_to_home + "' --early_stop " + str(early_stop_val) + " --model_path '../train/save_lambda_exp/rank_sig_{}_alpha_{}/epoch_5.pth'".format(sigma,alpha))