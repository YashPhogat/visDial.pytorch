...
for sigma in sigmas:
    for alpha in alphas:
        os.system("python train_D.py --cuda --path_to_home '"+ path_to_home + "' --num_val " + str(val) + " --early_stop " + str(early_stop_train) + " --pl_sigma " +str(sigma) + " --alpha_norm "+str(alpha) +" --exp_name 'rank_sig:{}_alpha:{}'".format(sigma,alpha))
