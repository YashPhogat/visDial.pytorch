...
early_stop_train = 10000
early_stop_val = 5000
for sigma in sigmas:
    for alpha in alphas:
        os.system("python train_D_lambda.py --cuda --path_to_home '"+ path_to_home + "' --early_stop " + str(early_stop_train) + " --pl_sigma " +str(sigma) + " --alpha_norm "+str(alpha) +" --exp_name 'lambda_sig:{}_alpha:{}'".format(sigma,alpha))
