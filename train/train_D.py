...
critD =model.nPairLoss(opt.ninp, opt.margin, opt.alpha_norm, opt.sigma, opt.sample_each_contra, opt.sample_each_entail, opt.sample_each_neutra, opt.debug, opt.log_interval)
